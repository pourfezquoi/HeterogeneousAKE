...
#define PRINT_TIMER_HEADER                                                                                                                                                                          \
    ...
    PRINT_CURRENT_TIME                                                                                                                                                                              \
    printf("\n");                                                                                                                                                                                   \
    printf("%-30s | %10s | %14s | %15s | %25s \n", "Operation                     ", "Iterations", "Total time (s)", "Time (us): mean", HIGH_PREC_HEADER); \
    printf("%-30s | %10s:| %14s:| %15s:| %25s:\n", "------------------------------", "----------", "--------------", "---------------", "-------------------------");
...
#define PRINT_TIMER_AVG(op_name) \
    printf("%-30s | %10" PRIu64 " | %14.3f | %15.3f | %25.0f\n", (op_name), _bench_iterations, ((double) _bench_time_cumulative) / 1000000.0, _bench_time_mean, ((double) _bench_cycles_cumulative) / (double) _bench_iterations);
