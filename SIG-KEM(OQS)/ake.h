...
int ake_send_A(OQS_KEM* kem_cpa, OQS_KEM* kem_cca, OQS_SIG* sig, const uint8_t *lpka, const uint8_t *lska, const uint8_t *lpkb, uint8_t *epka, uint8_t *send, size_t *sendlen, uint8_t *st);
